...
ADD COLUMN stripe_secret_key VARCHAR(255),
ADD COLUMN razorpay_key_id VARCHAR(255),
ADD COLUMN razorpay_key_secret VARCHAR(255),
ADD COLUMN whatsapp_api_key VARCHAR(255),
ADD COLUMN whatsapp_phone_number_id VARCHAR(255),
ADD COLUMN brand_logo_url VARCHAR(255),
